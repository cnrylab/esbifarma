...
<section id="login" class="full">
    ...
    <form class="cx-form validate" method="POST">
        ...
        <div class="obj">
            ...
            <input type="email" name="email" class="with-icon" spellcheck="false" autocomplete="off" placeholder="Your email address" required/>
        </div>

        <div class="obj">
            <label>Password</label>
            <i class="micon">password</i>
            <input type="password" name="password" class="with-icon" required placeholder="Your password"/>
